...
namespace Affidavit.Helpers
{
    public static class CultureHelper
    {
        ...
        public static string GetCultureName(string culture)
        {
            string _cultureName = "";
            //Switch Ingles
            string _currentCulture = GetCurrentCulture();

            if (_currentCulture.Equals("es"))
            {
                switch (culture)
                {
                    case "en-US":
                    ...
                    case "id":
                        ...
                        break;
                    case "th":
                        _cultureName = "Tailandés";
                        break;
                    case "fr":
                        _cultureName = "Francés";
                        break;
                }
            }
            else
            {
                ...
                {
                    case "en-US":
                        _cultureName = "English";
                        break;
                    case "es":
                        _cultureName = "Spanish";
                        break;
                    case "de":
                        _cultureName = "Deutch";
                        break;
